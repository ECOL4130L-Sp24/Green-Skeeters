...
ggplot(data = temp_mos_season_prop, 
    ...
    geom_point() +
<<<<<<< HEAD
  labs( x = "Mean temperature (°C)", y = "Proportion of positive test results") +
=======
  labs(x = "Mean temperature", y = "Proportion positive test results") +
>>>>>>> 4c93863dd06ae09aa310e812f9faad4cce71d65b
  theme_bw()
```
...
ggplot(data = temp_mos_season_prop, 
    ...
    geom_jitter(cex = 3,
                height = 0,
                width = 0.1) +
  labs( x = "Mean temperature of season (°C)", y = "Proportion of positive test results") +
  theme_bw()
```
