...
#Testing whether additive or interactive model is more appropriate

anova(model1, additive_model)

#Prefer complex model
```
...
ggplot(data = temp_mos_season, 
         aes(x = season, 
             y = testResult_mos)) +
    geom_boxplot(aes(col = siteID),
          width = 0.2) +
<<<<<<< HEAD
  scale_y_continuous(limits =  c(0, 0.5)) +
=======
  facet_wrap(~season) +
>>>>>>> e29a052d47cf734c313b719fe11655ea4ec02971
  theme_bw()
