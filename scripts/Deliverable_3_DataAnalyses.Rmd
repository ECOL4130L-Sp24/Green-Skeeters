...
<<<<<<< HEAD
```{r}
# Added a binary test result for mosquito data in order to easily run statistical tests
mosquito_binary <- mosquito_day %>% 
  mutate(testResult2= ifelse(testResult=="Positive",1,0))
```
=======
>>>>>>> 27229d122628b6adb63c085ac6a09eafc5da8827
