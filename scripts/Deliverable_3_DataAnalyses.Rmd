...
## ANOVA and graphs comparing temperature and mosquito pathogen positivity across sites
...
```{r}
#Graph of proportion of positive results over seasons per siteid
...
```{r}
#Graph of proportion of positive results of virus types per siteid  
